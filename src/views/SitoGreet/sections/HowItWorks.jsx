...
function HowItWorks() {
  ...
  return (
    <section className="sgSection">
      ...
      <ul className="sgList">
        <li>
          <code className="sgCode">manifest.json</code> {t("_pages:sitoGreetInfo.howItWorks.items.manifest.pre")} <code className="sgCode">newtab.html</code> {t("_pages:sitoGreetInfo.howItWorks.items.manifest.post")}
        </li>
        <li>
        ...
        <li>{t("_pages:sitoGreetInfo.howItWorks.items.featureFlags")}</li>
      </ul>
    </section>
  );
}
