...
function Preview() {
  ...
  return (
    <div className="sgPreview">
      <section
        className="sitoGreet"
        aria-label={t('_pages:sitoGreetInfo.preview.sectionAria')}
      >
        <header
          className="topInfo"
          aria-label={t('_pages:sitoGreetInfo.preview.headerAria')}
        >
          ...
          <p className="topText weather" aria-live="polite">
            ...
            <span className="sep">·</span>
            <span className="advice">{t('_pages:sitoGreetInfo.preview.advice')}</span>
          </p>
        </header>

        <main className="center" role="main">
          <h1 className="greeting">{t('_pages:sitoGreetInfo.preview.greeting')}</h1>
          <p className="subtext">{t('_pages:sitoGreetInfo.preview.profile')}</p>
        </main>
        ...
        <footer className="footer">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label={t('_pages:sitoGreetInfo.preview.githubAria')}
          >
          ...
          <p className="footerCenter">
            <span>{t('_pages:sitoGreetInfo.preview.madeBy')} </span>
